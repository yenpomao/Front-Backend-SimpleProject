...
function addPlayer() {
    ...
    const newPlayer = new Player(name, elo);
...
function thePowerOfClick() {
    document.getElementById("b1").value = "You click I knew it";
    document.getElementById("b1").disabled = true;
    document.getElementById("print").innerHTML = "HAHAAHAHAHA"
